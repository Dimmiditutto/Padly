Verifica approfonditamente che 1. il codice sia coerente nel suo complesso 2. che i files modificati siano coerenti tra loro 3. che i files modificati non creino conflitti/blocchi né tra loro né a livello di codice complessivo 4. che a livello di codice complessivo non ci siano conflitti/blocchi/criticità 5. che la logica di business sia stata rispettata. Non apportare modifiche ma scrivi i risultati della verifica e scrivi un prompt operativo ed efficace da cui partire per eseguire eventuali fix.
